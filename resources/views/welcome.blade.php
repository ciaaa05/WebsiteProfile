    ...
    <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%"
        ...
        <section id="home">
            <div class="container-fluid align-items-center"
                style="min-height: 91vh; background-image: url('assets/bg2.png');">
                <div class="container" style="max-height: 91vh;">
                    <div class="row align-item-center  d-flex flex-row">
                        <div class="col-6 description text-center text-lg-left">
                            ...
                            <h1 class="display-3 text-uppercase text-primary mb-0"
                                style="-webkit-text-stroke:4px #ffffff;">Alicia Josephine Ekosputri</h1>
            ...
            <div class="about-me container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pt-lg-0 content">
                        ...
                        <p class="font-italic">
                            Hi! I'm just an ordinary girl who will always work hard. There's no "give up" in my
                            dictionary. I like to learn new things, such as languages, guitar, design, etc. Here is my
                            biodata~
                        </p>
                        ...
                        <div class="col-lg-6">
                            <ul>
                                ...
                                <li><i class="icofont-rounded-right"></i> <strong>Occupation:</strong> College Student
                                </li>
                                <li><i class="icofont-rounded-right"></i> <strong>Location:</strong> Jember, Indonesia
                                </li>
                            </ul>
                        </div>

                        <p>
                            "No matter what the problem, still be royal to the original intention. Treat the world
                            gently, treat everyone with kindness. Be Brave. Be Strong. Never Give Up. God will always
                            with you."
                        </p>
                    </div>
                </div>
            ...
            <div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="resume-item">
                            <h4>Event Section of Frontpage 2023</h4>
                            <h5>2023</h5>
                        </div>
                        <div class="resume-item">
                            <h4>Member of Mathematics Competition Team in Senior High School</h4>
                            <h5>2018 - 2020</h5>
                        </div>
                        <div class="resume-item">
                            <h4>Senior High School Library Ambassador</h4>
                            <h5>2018 - 2020</h5>
                        </div>
                    </div>
                </div>
